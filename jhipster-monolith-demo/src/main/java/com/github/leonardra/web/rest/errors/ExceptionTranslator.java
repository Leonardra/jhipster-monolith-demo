package com.github.leonardra.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.github.leonardra.service.EmailAlreadyUsedException ||
            ex instanceof com.github.leonardra.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.github.leonardra.service.InvalidPasswordException
